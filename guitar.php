...
if (isset($_GET['add'])) {
	...
	header('Location:' . $page);
     ...
     $query="SELECT * FROM products where category = 'Guitar'";
	 if(isset($_GET['sort'])){
	 //echo query;
	 }
	 ...
	 while ($row = mysqli_fetch_assoc($result)) {
		 ...
		 echo '<td><img " src="../Markus/Product/'.$row['imageName'] .' "height="290px auto" width="250px auto" alt="guitar" /></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <br/>' . $row['name'].'&nbsp;&nbsp;<br/>$' . $row['price'].'<br/><a href=cart.php?add=' .$row['productID'] .'"><button>Add To Cart</button></td>';
